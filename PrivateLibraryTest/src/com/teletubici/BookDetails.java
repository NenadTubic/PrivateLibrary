...
public class BookDetails {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("/html/body/div/div/main/div[2]/div[2]/div[7]/div/div[2]/div/button[1]")).click();
		
		assertTrue(driver.findElement(By.xpath("/html/body/div/div/main/div[2]/div[1]/p")).getText().equalsIgnoreCase("Na Drini Cuprija"));
		assertTrue(driver.findElement(By.xpath("/html/body/div/div/main/div[2]/div[2]/div[2]")).getText().equalsIgnoreCase("Year: 1995"));
		assertTrue(driver.findElement(By.xpath("/html/body/div/div/main/div[2]/div[2]/div[3]")).getText().equalsIgnoreCase("ISBN: 1231231231231"));
		assertTrue(driver.findElement(By.xpath("/html/body/div/div/main/div[2]/div[2]/div[4]")).getText().equalsIgnoreCase("Genre: Horor"));
		assertTrue(driver.findElement(By.xpath("/html/body/div/div/main/div[2]/div[2]/div[5]")).getText().equalsIgnoreCase("Rating: 5"));
		driver.quit();
	}
